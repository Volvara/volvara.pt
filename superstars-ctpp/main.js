(function(){
  ...
  async function loadData() {
    try {
      // GitHub Contents API: sem cache agressivo, 60 req/hora sem auth
      var headers = { Accept:'application/vnd.github.v3+json' };
      var ts = '?t='+Date.now(); // previne cache do browser
      var [jogRes, etaRes, resRes] = await Promise.all([
        ...
        fetch(API_BASE+'resultados.json'+ts, {headers:headers})
      ]);
